...
public class Client {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            System.out.println("2 - операции с с покупателями");
    ...
    public static void customerOperations(){
        while(true){
            try{
                ...
                switch (input) {
                    case "1":
                        System.out.println("Введите имя покуателя");
                    ...
                    case "4":
                        System.out.println("Введите идентификатор покупателя");
                        id = Integer.parseInt(scanner.nextLine());
                        System.out.println("Введите новое имя покуателя");
                    ...
                    case "7":
                        ...
                        break;
                    case "8":
                        System.out.println("Количество покупателей: " + customerController.getActiveCustomerCount());
                        break;
                    case "9":
                        System.out.println("Введите идентификатор покупателя");
                        id = Integer.parseInt(scanner.nextLine());
